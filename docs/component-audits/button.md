...
| ButtonGroup, menu button, split button, compound button | Separate | They require grouping, popup, roving/expanded state, or multi-line interaction contracts beyond one action button. |
