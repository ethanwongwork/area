...
export function Workbench() {
  ...
  return <div className="workbench" data-area-theme={theme} data-area-accent={accent} data-area-ui={ui} data-area-contrast={contrast} data-area-surface="outlined">
