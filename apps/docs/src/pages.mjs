...
export const COMPONENT_PAGES = [
  ...
  },
  {
    ...
    practices: [
      "Use Token only for a static design-token reference. Use Code for literal source, Kbd for a shortcut, Badge for status/metadata, and Chip or a future TokenInput composition for a selected or removable value.",
      "One relative size follows the surrounding type role, so a token remains compact in a table and in prose without a call-site size decision. Token deliberately owns no size tier.",
